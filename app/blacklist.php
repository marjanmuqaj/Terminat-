...
<body>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div id="editContent">
                            ...
                            <label class="checkbox-inline" style="font-weight: bold;"><input type="checkbox" name="kategoria[]" class="kategoria" value="Fenerim">Fenerim</label><br><br>
                            <textarea class="form-control" id="arsyea" placeholder="Arsyea"></textarea>
    ...
    <script type="text/javascript">
        ...
        function manageData(key) {
            ...
            if (isNotEmpty(name)  && isNotEmpty(numri) && isNotEmpty(data)&& isNotEmpty(ora)&& isNotEmpty(kapari) &&isNotEmpty(arsyea))
            {
                $.ajax({
                    url: 'ajaxblacklist.php',
                    method: 'POST',
